...
trait PetHttpService extends HttpService {
  ...
  @ApiOperation(value = "Add a new pet to the store", nickname = "addPet", httpMethod = "POST", consumes = "application/json, application/vnd.custom.pet", response = classOf[Pet])
  @ApiImplicitParams(Array(
